...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/felipementel/DEPLOY.GitFilterRepo.GitLeaks/ci-cd.yml?branch=main&style=for-the-badge)
...
Instalar o git-filter-repo via pip:

```powershell
py -3.14 -m pip install git-filter-repo
```
